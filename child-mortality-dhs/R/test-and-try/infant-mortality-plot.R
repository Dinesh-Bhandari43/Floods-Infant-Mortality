...
monthly_time_series_qs_flooded_vs_non_flooded <- (monthly_time_series
                                                  ...
                                                  %>% mutate(Number_Of_Birth_QS_Season = sum(Number_Of_Birth_QS, na.rm = T),
                                                             Number_Of_Dead_Birth_QS_Season = sum(Number_Of_Dead_Birth_QS, na.rm = T),
                                                             Infant_Mortality_Quarterly_Smoothed_Season = Number_Of_Dead_Birth_QS_Season/Number_Of_Birth_QS_Season,
                                                             Infant_Mortality_Season = Infant_Mortality_Quarterly_Smoothed_Season)
                                                  )
...
monthly_time_series_qs_flooded_vs_non_flooded_RR <- (monthly_time_series_qs_flooded_vs_non_flooded
                                                     ...
                                                     %>% mutate(Infant_Mortality_Season_RR = Infant_Mortality_Season.x / Infant_Mortality_Season.y,
                                                                Infant_Mortality_Season_SE_ln_RR = sqrt((1/Number_Of_Dead_Birth_QS_Season.x) - (1/Number_Of_Birth_QS_Season.x)
                                                                                                 + (1/Number_Of_Dead_Birth_QS_Season.y) - (1/Number_Of_Birth_QS_Season.y)),
