...
flood_year <- raster::stack(here("data/final", "flood_year.grd"))

# DHS birth records
BDBR_2017 <- read_dta(here("data/untouched/dhs",
                           "BD_2017-18_DHS_05302023_1738_172978/BDBR7RDT",
                           "BDBR7RFL.DTA"))
BDBR_2014 <- read_dta(here("data/untouched/dhs",
                           "BD_2014_DHS_05302023_1739_172978/BDBR72DT",
                           "BDBR72FL.DTA"))
BDBR_2011 <- read_dta(here("data/untouched/dhs",
                           "BD_2011_DHS_05302023_1739_172978/BDBR61DT",
                           "BDBR61FL.DTA"))
BDBR_2007 <- read_dta(here("data/untouched/dhs",
                           "BD_2007_DHS_05302023_1740_172978/BDBR51DT",
                           "BDBR51FL.DTA"))
BDBR_2004 <- read_dta(here("data/untouched/dhs",
                           "BD_2004_DHS_05302023_1740_172978/BDBR4JDT",
                           "BDBR4JFL.DTA"))
BDBR_1999 <- read_dta(here("data/untouched/dhs",
                           "BD_1999-00_DHS_05302023_1740_172978/BDBR41DT",
                           "BDBR41FL.DTA"))
