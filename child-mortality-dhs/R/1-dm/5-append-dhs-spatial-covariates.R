...
BDGC7RFL <- read.csv(here("data/untouched/dhs/BD_2017-18_DHS_05302023_1738_172978/BDGC7RFL/BDGC7RFL/BDGC7RFL.csv"))
BDGC72FL <- read.csv(here("data/untouched/dhs/BD_2014_DHS_05302023_1739_172978/BDGC72FL/BDGC72FL.csv"))
BDGC62FL <- read.csv(here("data/untouched/dhs/BD_2011_DHS_05302023_1739_172978/BDGC62FL/BDGC62FL.csv"))
BDGC52FL <- read.csv(here("data/untouched/dhs/BD_2007_DHS_05302023_1740_172978/BDGC52FL/BDGC52FL.csv"))
BDGC4JFL <- read.csv(here("data/untouched/dhs/BD_2004_DHS_05302023_1740_172978/BDGC4JFL/BDGC4JFL.csv"))
BDGC42FL <- read.csv(here("data/untouched/dhs/BD_1999-00_DHS_05302023_1740_172978/BDGC42FL/BDGC42FL.csv"))
...
BDGC7RFL <- (BDGC7RFL %>% mutate(UN_Population_Density_2015 = replace(UN_Population_Density_2015, UN_Population_Density_2015 == 0, NA))) #Recode missing values
